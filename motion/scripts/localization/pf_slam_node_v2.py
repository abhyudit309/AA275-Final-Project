...
from utils.particle_filter_slam_v2 import MonteCarloLocalization
...
class LocalizationVisualizer(Node):
    ...
    def run(self):
        ...
        self.EKF = MonteCarloLocalization(x0s, 10. * NoiseParams["R"], self.base_to_camera, NoiseParams["g"])
